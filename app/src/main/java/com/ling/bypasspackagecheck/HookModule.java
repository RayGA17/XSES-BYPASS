package com.ling.bypasspackagecheck;
...
public class HookModule implements IXposedHookZygoteInit, IXposedHookLoadPackage {
    ...
    private static void hookInstaller(ClassLoader classLoader) {
        try {
            ...
            if (installerClass == null) {
                XposedBridge.log(TAG + "### P 4: INSTALLER CLS NOT FOUND SKIP");
                return;
            }
            ...
            XposedBridge.log(TAG + "### P 4: INSTALLER HOOK FAIL " + t);
        }
    }
    ...
    private static void hookActivityManagerService(ClassLoader classLoader) {
        try {
            ...
            if (amsClass == null) {
                XposedBridge.log(TAG + "### P 4: AMS CLS NOT FOUND SKIP");
                return;
            }
            XposedBridge.log(TAG + "P 4: AMS MULTI HOOK START");

            XposedHelpers.findAndHookMethod(amsClass, "xseException", boolean.class, new XC_MethodHook() {
                @Override
                protected void beforeHookedMethod(MethodHookParam param) {
                    XposedBridge.log(TAG + "--- INTERCEPT: AMS.XSEEXCEPTION BLOCKED INPUT " + param.args[0]);
                    param.setResult(null);
                }
            });
            XposedBridge.log(TAG + "P 4: AMS.XSEEXCEPTION HOOK SUCCESS");
            ...
            if (processRecordClass == null) {
                XposedBridge.log(TAG + "### P 4: PROCESSRECORD CLS NOT FOUND SKIP UNCERTIFIED");
            } else {
            ...
            XposedBridge.log(TAG + "### P 4: AMS HOOK FAIL " + t);
        }
    }
    ...
    private static void hookPowerManagerService(ClassLoader classLoader) {
        try {
            ...
            if (pmsClass == null) {
                XposedBridge.log(TAG + "### P 4: PMS CLS NOT FOUND SKIP");
                return;
            }
            XposedHelpers.findAndHookMethod(pmsClass, "reboot", boolean.class, String.class, boolean.class, new XC_MethodHook() {
                @Override
                protected void beforeHookedMethod(MethodHookParam param) {
                    if (param.args[1] == null) return;
                    String reason = (String) param.args[1];
                    if ("xsebootloader".equals(reason)) {
                        XposedBridge.log(TAG + "--- INTERCEPT: PMS.REBOOT XSEBOOTLOADER BLOCKED");
                        param.setResult(null);
                    }
                }
            });
            XposedBridge.log(TAG + "P 4: PMS HOOK SUCCESS");
        } catch (Throwable t) {
            XposedBridge.log(TAG + "### P 4: PMS HOOK FAIL " + t);
        }
    }
    ...
    private static void hookXsesService(ClassLoader classLoader) {
        try {
            ...
            if (xsesClass == null) {
                XposedBridge.log(TAG + "### P 4: XSES CLS NOT FOUND SKIP");
                return;
            }
            ...
            XposedBridge.log(TAG + "### P 4: XSES HOOK FAIL " + t);
        }
    }
        ...
        try {
            ...
            if (behaviorClass == null) {
                if (android.os.Process.myUid() < 2000) {
                    XposedBridge.log(TAG + "### BEHAV CLS NOT FOUND SKIP");
                }
                return;
            }
            XposedHelpers.findAndHookConstructor(behaviorClass, Context.class, String.class, LinkedHashMap.class, new XC_MethodHook() {
                @Override
                protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                    if (param.args[1] == null || param.args[2] == null) return;
                    String eventName = (String) param.args[1];
                    LinkedHashMap<String, String> payload = (LinkedHashMap<String, String>) param.args[2];
            ...
            if (android.os.Process.myUid() < 2000) {
                XposedBridge.log(TAG + "### BEHAV HOOK FAIL " + t);
            }
        }
    }
    ...
    public void initZygote(StartupParam startupParam) throws Throwable {
        ...
        try {
            ...
            if (buildClass == null) {
                XposedBridge.log(TAG + "### P 0.1: BUILD CLS NOT FOUND SKIP");
                return;
            }
            ...
            XposedBridge.log(TAG + "### P 0.1: BUILD MOD FAIL " + t);
        }
    }
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        ...
        try {
            ...
            if (ssmClass == null) {
                XposedBridge.log(TAG + "### P 2: SSM CLS NOT FOUND   ");
                return;
            }
            ...
            XposedBridge.log(TAG + "### P 2: SSM LISTENER FAIL " + t);
        }
    }
}